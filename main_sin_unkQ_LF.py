...
import torch
from NUV_test import Unknown_Q_LF_Tester
...
def test_batch(nu_r):
    ...
    tester = Unknown_Q_LF_Tester(lin_model)
    # idx for trace back
    idices = [idx_nu, idx_r]
    # test
    MSE_and_std = tester.test(NB, test_input, X_target, U_target, init_unknown=q, itr=80, forget_itr=0.0)     
    # save estimates
...
if __name__ == '__main__':
    main(opath='Sim_sin_Q/Pd100/LF/', bpath='Sim_baseline/KS/')
